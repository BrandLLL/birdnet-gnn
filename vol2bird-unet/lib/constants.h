...
// number of output classes of the segmentation model.
// The U-Net model outputs 2 classes: non-biological and biological.
#define MISTNET_N_CLASS 2
// predict a pixel as non-biological (weather/clutter) if its biological class
// probability is below this threshold (equivalently non-bio prob above 1-threshold)
#define MISTNET_BIOLOGY_THRESHOLD 0.45
// predict a pixel as non-biological if the average biological class probability
// across all five elevations at that spatial location is below this threshold
#define MISTNET_SCAN_AVERAGE_BIOLOGY_THRESHOLD 0.45
// segmentation model tensor indices for the non-biological and biological
// class probabilities. The U-Net emits a class-major tensor [class][elev][x][y].
#define MISTNET_NONBIOLOGY_INDEX 0
#define MISTNET_BIOLOGY_INDEX 1
// value reserved in the weather cell map for pixels identified as non-biological
...
#define VERSION "0.6.0.9204"
// Date of latest version of the program
#define VERSIONDATE "27-Mar-2025"
